...
import com.hewuzhe.ui.activity.SearchOnlineVideosActivity;
 ...
 */
public class SearchOnlineVideosPresenter extends RefreshAndLoadMorePresenter<SearchVideosView> {
    ...
    public void getData(final int page, final int count) {
        ...
        Subscription subscription = NetEngine.getService()
                .GetOnlineStudyList((page - 1) * count, count, SearchOnlineVideosActivity.CAT_ID, keyword)
