...
import com.hewuzhe.presenter.BasicVideoPresenter;
...
public class BasicVideoTwoActivity extends ToolBarActivity<BasicVideoPresenter> implements
        VDVideoExtListeners.OnVDVideoInsertADListener, VDVideoExtListeners.OnVDVideoFrameADListener,
        VDVideoExtListeners.OnVDVideoPlaylistListener, BasicVideoView {
...
//        videoController.start();
        ...
        presenter.getVideoDetail(getIntentData().getInt("Id"));
     ...
     */
    @Override
    public BasicVideoPresenter createPresenter() {
        return new BasicVideoPresenter();
    }
    ...
    public void setData(Video video) {
        ...
        adIV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Toast.makeText(BasicVideoTwoActivity.this, "点击了静帧广告",
...
//        }
        // 初始化播放器以及播放列表
        mVDVideoView.open(BasicVideoTwoActivity.this, infoList);
        // 开始播放，直接选择序号即可
        mVDVideoView.play(0);
