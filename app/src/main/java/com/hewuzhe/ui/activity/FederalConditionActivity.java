...
public class FederalConditionActivity extends ToolBarActivity<FederalConditionPresenter> implements FederalConditionView {
    ...
    protected void initThings(Bundle savedInstanceState) {
        ...
        presenter.getCates("GetLianmengCate");
