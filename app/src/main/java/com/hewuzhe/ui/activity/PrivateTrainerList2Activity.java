...
/**
 * Created by ninos on 2016/4/28.
 */
public class PrivateTrainerList2Activity extends SwipeRecycleViewActivity<PrivateTrainerListPresenter, PrivateTrainerListAdapter, PrivateTrainerList> implements AdapterView.OnItemClickListener, PrivateTrainerListView, LocationSource, AMapLocationListener {
...
//        sheng = aMapLocation.getProvince();
    ...
    public void searchClick(){
        ...
        startActivity(new Intent(this, SearchPtlActivity.class).putExtra("data",getStringData()));
    }
