 ...
 */
public class ArticleCommentAdapter extends BaseAdapter<ArticleCommentAdapter.ViewHolder, Comment, ArticlePresenter> {

    private int whitch = C.WHITCH_DEFAUT;

    public ArticleCommentAdapter(Context context, ArticlePresenter articlePresenter, View header, int whitch) {
        super(context, articlePresenter, header);
        this.whitch = whitch;

    }

    public ArticleCommentAdapter(Context context, ArticlePresenter articlePresenter, View header) {
        super(context, articlePresenter, header);
    }
