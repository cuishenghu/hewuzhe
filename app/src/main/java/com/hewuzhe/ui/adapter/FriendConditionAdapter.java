 ...
 */
public class FriendConditionAdapter extends BaseAdapter<FriendConditionAdapter.VHolder, FriendCondition, ConditionPresenter> {
    /**
     * 每行有几张图片
     */
    private int count = 3;
    ...
    public void bindData(final VHolder holder, final int position) {
        ...
        if (condition.Description != null) {//转发时评论不为空显示,为空不显示
            ...
            holder._TvComment.setVisibility(View.GONE);
        }
