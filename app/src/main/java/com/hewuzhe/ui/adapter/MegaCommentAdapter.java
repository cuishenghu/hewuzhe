 ...
 */
public class MegaCommentAdapter extends BaseAdapter<MegaCommentAdapter.ViewHolder, MegaComment, BasePresenterImp> {

    private int whitch = C.WHITCH_DEFAUT;

    public MegaCommentAdapter(Context context, CommentPresenter commentPresenter, View header, int whitch) {
        super(context, commentPresenter, header);
        this.whitch = whitch;

    }

    public MegaCommentAdapter(Context context, CommentPresenter commentPresenter, View header) {
        super(context, commentPresenter, header);
    }
    ...
    public void bindData(ViewHolder holder, int position) {
        ...
        MegaComment comment = data.get(position);

        holder.tvName.setText(comment.NicName);
        holder.tvAddTime.setText(TimeUtil.timeAgo(comment.VoteTime));
