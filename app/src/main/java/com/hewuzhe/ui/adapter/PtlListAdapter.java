 ...
 */
public class PtlListAdapter<T> extends BaseAdapter {
    ...
    public PtlListAdapter(Context context, List<T> mObjects, int resource, int cate, int width) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Address address = (Address)mObjects.get(position);
        vHolder.classification_name.setText(address.Name);
        vHolder.classification_name.setHeight( width / 7);
