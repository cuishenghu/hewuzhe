 ...
 */
public abstract class BaseNoMoreAdapter<VH extends RecyclerView.ViewHolder, M, P extends BasePresenterImp> extends RecyclerView.Adapter<VH> {
    ...
    public BaseNoMoreAdapter(Context context, P p) {
        this.context = context;
        _inflater = LayoutInflater.from(context);
        this._presenter = p;
        init();
    ...
    public BaseNoMoreAdapter(Context context, View header) {
        this.context = context;
        _inflater = LayoutInflater.from(context);
        this.header = header;
        init();
    ...
    public BaseNoMoreAdapter(Context context, P p, View header) {
        this.context = context;
        _inflater = LayoutInflater.from(context);
        this.header = header;
        this._presenter = p;
    ...
    public BaseNoMoreAdapter(Context context, boolean isAddFooter) {
        this.context = context;
        _inflater = LayoutInflater.from(context);
    ...
    public BaseNoMoreAdapter(Context context, P p, boolean isAddFooter) {
        this.context = context;
        _inflater = LayoutInflater.from(context);
        this._presenter = p;
        this.isAddFooter = isAddFooter;
    ...
    public BaseNoMoreAdapter(Context context, View header, boolean isAddFooter) {
        this.context = context;
        _inflater = LayoutInflater.from(context);
        this.header = header;
        this.isAddFooter = isAddFooter;
    ...
    public BaseNoMoreAdapter(Context context, P p, View header, boolean isAddFooter) {
        this.context = context;
        _inflater = LayoutInflater.from(context);
        this.header = header;
        this._presenter = p;
