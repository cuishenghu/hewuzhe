 ...
 */
public class OtherImgsAdapter extends BaseAdapter<OtherImgsAdapter.VHolder, OtherImage, PlanDetailPresenter> {
     ...
     * @param context
     */
    public OtherImgsAdapter(Context context) {
        super(context);
        isAddFooter = false;
    }
    ...
    public void bindData(VHolder holder, int position) {
        OtherImage uploadImage = data.get(position);
        Glide.with(context)
