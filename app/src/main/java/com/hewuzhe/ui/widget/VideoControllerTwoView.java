 ...
 */
public class VideoControllerTwoView extends FrameLayout implements View.OnTouchListener, Slider.OnValueChangedListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener {
    ...
    public VideoControllerTwoView(Context context) {
        super(context);
        initView(context);
    }

    public VideoControllerTwoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    ...
    public VideoControllerTwoView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setVideoPlayButton() {
        viewPlay.setImageDrawable(context.getResources().getDrawable(R.mipmap.icon_play));
    ...
    public void onCompletion(MediaPlayer mp) {
        viewPlay.setImageDrawable(context.getResources().getDrawable(R.mipmap.icon_pause, null));
