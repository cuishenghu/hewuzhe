 ...
 */
public interface ArticleCollectionsView extends LoadMoreView,ListView<ArticleCollection>,SwipeRefreshView,GetView<Integer> , OnReceiveListener<Integer, Boolean> {
