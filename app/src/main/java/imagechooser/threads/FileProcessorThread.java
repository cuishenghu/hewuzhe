...
import imagechooser.api.ChosenFile;
    ...
    public void setContext(Context context) {
        ...
        if (filePath.startsWith("content")) {
            ...
            try {
                ...
                StreamHelper.verifyStream(filePath, stream);
                mimeType = URLConnection.guessContentTypeFromStream(stream);
            } catch (IOException | ChooserException e) {
                Log.e(TAG, e.getMessage(), e);
                // Do nothing
            } finally {
                StreamHelper.closeSilent(stream);
            }
            if (mimeType == null) {
    ...
    protected void processFileDetails(String path) throws ChooserException {
        ...
        if (filePath.startsWith("content:")) {
            ...
            try {
                ...
                StreamHelper.verifyStream(filePath, inputStream);
